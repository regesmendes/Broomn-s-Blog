...
| GET | `/analytics/summary?from=&to=` | Grouped counts for a period (defaults to last 30 days) — users, posts (new/reads/comments), newsletter (subscribed/unsubscribed/blocked/pending), backend (API requests) |
