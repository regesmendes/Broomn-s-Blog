...
export default function LoginPage() {
  ...
  const googleAuthUrl = `${cognitoDomain}/oauth2/authorize?response_type=code&client_id=${clientId}&redirect_uri=${encodeURIComponent(redirectUri || '')}&identity_provider=Google&scope=openid+email+profile`;
