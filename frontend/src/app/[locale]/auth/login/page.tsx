  ...
  return (
    <div className="mx-auto flex max-w-md flex-col items-center px-4 py-20">
      ...
      <p className="mb-8 text-center text-gray-600">
        Sign in to access the admin area and comment on posts.
      </p>
      ...
      {googleAuthUrl ? (
        ...
        <div className="w-full rounded-md bg-yellow-50 p-4 text-center text-sm text-yellow-800">
          Google OAuth not configured (Cognito env vars missing).
        </div>
      )}
      ...
      {isDev && (
        <div className="mt-8 w-full border-t border-gray-200 pt-8">
          <p className="mb-4 text-center text-sm font-medium text-gray-500">Development Login</p>
